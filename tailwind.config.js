    ...
    extend: {
      colors: {
        aether: {
          ...
          /* AI-specific semantic tokens */
          code: 'var(--aether-code-bg)',
          'code-text': 'var(--aether-code-text)',
          'code-header': 'var(--aether-code-header-bg)',
          'code-header-text': 'var(--aether-code-header-text)',
          'code-border': 'var(--aether-code-border)',
          'blockquote-bg': 'var(--aether-blockquote-bg)',
          'blockquote-border': 'var(--aether-blockquote-border)',
          'blockquote-text': 'var(--aether-blockquote-text)',
          'ai-panel': 'var(--aether-ai-panel-bg)',
          'ai-panel-border': 'var(--aether-ai-panel-border)',
          'ai-panel-item': 'var(--aether-ai-panel-item-bg)',
          'ai-panel-item-hover': 'var(--aether-ai-panel-item-hover)',
          'table-header': 'var(--aether-table-header-bg)',
          'table-border': 'var(--aether-table-border)',
          'table-text': 'var(--aether-table-text)',
          'table-text-muted': 'var(--aether-table-text-muted)',
        },
        surface: {
