    ...
    <PageWrapper>
      <div className="flex min-h-[400px] items-center justify-center p-4">
        <div className="max-w-sm space-y-6 text-center">
          <div className="text-7xl font-black leading-none text-slate-700 dark:text-slate-800">404</div>
          <div>
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl border border-slate-300 dark:border-slate-700 px-4 py-2.5 text-xs font-medium text-slate-700 dark:text-slate-300 transition-colors hover:border-slate-500"
            >
