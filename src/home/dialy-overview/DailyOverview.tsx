...
export const DailyOverview: React.FC = () => {
  ...
  if (isLoading) {
    return <div className="h-32 bg-slate-800/40 animate-pulse rounded-xl" />;
  }

  return (
    <section className="space-y-3">
      <h2 className="text-lg font-bold text-white tracking-wide">Daily Performance Overview</h2>
