    ...
    weeklyPicks: [
      {
        ...
        description: 'Your peak focus period is between 9 AM and 11:30 AM. Move routine standups to late afternoon.',
    ...
    freshAngles: [
      {
        ...
        description: 'Analyzing your recent commits shows high execution overhead in parsing pipelines.',
    ...
    direction: [
      {
        ...
        description: 'Current velocity suggests Q3 architectural goals need 10% more focus allocation.',
        category: 'Direction',
        priority: 'low',
        impactScore: 84,
