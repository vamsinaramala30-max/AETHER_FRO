...
export const BuilderSidebar: React.FC<Props> = ({ onAddStep }) => {
  ...
  return (
    <div className="space-y-3 border-b border-slate-200 p-4 dark:border-slate-800 lg:border-b-0 lg:border-r">
      ...
      <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-3 lg:grid-cols-1">
        {stepPalette.map((item) => {
          ...
          return (
            ...
            >
              <div
                className={`mt-0.5 flex h-8 w-8 items-center justify-center rounded-lg border ${item.color}`}
              >
