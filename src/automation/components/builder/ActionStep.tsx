...
export const ActionStepCard: React.FC<Props> = ({ step, isSelected, onSelect, onRemove }) => {
  return (
    <div
      onClick={onSelect}
      className={`p-4.5 cursor-pointer rounded-2xl border transition-all ${
        isSelected
          ? 'border-emerald-500 bg-emerald-500/5 ring-4 ring-emerald-500/10 dark:border-emerald-400 dark:bg-emerald-500/10'
