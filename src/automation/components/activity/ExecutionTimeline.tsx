...
export const ExecutionTimeline: React.FC<Props> = ({ stepLogs }) => {
  return (
    <div className="relative space-y-4 pl-4 before:absolute before:bottom-2 before:left-2 before:top-2 before:w-0.5 before:bg-slate-200 dark:before:bg-slate-800">
      {stepLogs.map((step, i) => (
        <div key={step.stepId || i} className="relative flex items-start gap-3">
          ...
          <div className="shadow-xs w-full rounded-xl border border-slate-200/80 bg-white p-3 dark:border-slate-800 dark:bg-slate-900">
