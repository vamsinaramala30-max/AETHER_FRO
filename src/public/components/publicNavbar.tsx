...
export const PublicNavbar: React.FC = () => {
  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-50 border-b border-zinc-800/80 bg-[#0B0D12] backdrop-blur-md">
      ...
      <div
        ...
        className={`${
          isOpen ? 'block' : 'hidden'
        } space-y-3 border-b border-zinc-800 bg-[#0B0D12] px-4 pb-6 pt-2 transition-all duration-200 md:hidden`}
      >
