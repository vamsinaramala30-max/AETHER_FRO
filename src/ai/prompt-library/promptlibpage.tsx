...
export const PromptLibraryPage: React.FC = () => {
  ...
  return (
    <PageWrapper wide>
      <div className="flex w-full flex-col overflow-hidden rounded-2xl border border-aether-border bg-aether-surface md:flex-row">
        {/* Categories Workspace Side Panel */}
        <div className="w-full shrink-0 border-b border-slate-100 bg-white p-4 dark:border-slate-800 dark:bg-slate-900 md:w-64 md:border-b-0 md:border-r">
          <div className="mb-4 flex items-center justify-between px-1 md:px-3">
            ...
            <button
              ...
              className="flex cursor-pointer items-center gap-1 rounded bg-indigo-50 px-2 py-1 text-xs font-semibold text-indigo-600 transition-all hover:opacity-80 dark:bg-indigo-950 dark:text-indigo-400"
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6">
          <div className="mb-6 flex flex-col gap-3 border-b border-slate-200 pb-4 dark:border-slate-800 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">
                Pre-engineered macro profiles injecting strict functional boundaries inside
                downstream completion scopes.
              </p>
            </div>
            <button
              onClick={() => {
              ...
              className="hidden items-center justify-center rounded-xl bg-indigo-600 px-4 py-2 text-xs font-semibold text-white shadow-sm transition-all hover:bg-indigo-500 sm:flex"
            >
              + Create Blueprint
            </button>
          </div>
