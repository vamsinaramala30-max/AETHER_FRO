...
export const DEFAULT_AI_CONFIG: AIConfig = {
  backend: {
    ...
    timeoutMs: 60_000,
    streamPath: '/api/ai/stream',
    chatPath: '/api/ai/chat',
    modelsPath: '/api/ai/models',
    memoryPath: '/api/ai/memory',
    knowledgePath: '/api/ai/knowledge',
    agentPath: '/api/ai/agents',
    toolsPath: '/api/ai/tools',
    promptsPath: '/api/ai/prompts',
